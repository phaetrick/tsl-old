...
function(iplug_configure_auv3iosframework target project_name)
  target_link_libraries(${target} PUBLIC iPlug2::AUv3iOS "-framework StoreKit")
  ...
  # Explicitly add IGraphicsIOS_view.mm to the framework target.
  # IGraphicsTSL.cpp is #included directly by IGraphicsIOS.mm — don't add it here.
...
<dict>
	...
	<string>com.thesecretlaboratory.apps.${project_name}.AUv3Framework</string>
...
")
  ...
  set_target_properties(${target} PROPERTIES
    ...
    XCODE_ATTRIBUTE_PRODUCT_BUNDLE_IDENTIFIER "com.thesecretlaboratory.apps.${project_name}.AUv3Framework"
  )
