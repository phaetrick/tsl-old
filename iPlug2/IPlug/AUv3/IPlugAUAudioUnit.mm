...
//        break;
    ...
    // Continuous params with a display func provide strings through the parameter
    // tree's implementorStringFromValueCallback; advertise that to hosts.
    if (pParam->HasDisplayFunc())
