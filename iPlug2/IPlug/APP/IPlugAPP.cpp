...
void IPlugAPP::AppProcess(double **inputs, double **outputs, int nFrames) {
    SetChannelConnections(ERoute::kInput, 0, MaxNChannels(ERoute::kInput), inputs != nullptr);
    SetChannelConnections(ERoute::kOutput, 0, MaxNChannels(ERoute::kOutput), outputs != nullptr);
