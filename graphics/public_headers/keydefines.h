...
namespace tsl {
	namespace graphics {
		...
		char VKtoChar(int vk, bool shiftPressed);

		// True for keys a TextInput consumes as edits: printable characters
		// (either shift state) plus backspace/delete. Used to decide what may
