...
#include <stdint.h> // Add this include at the top of the file to define uint8_t and other fixed-width integer types.
...
#if defined(_MSC_VER)
  #define LAME_ATTR_VISIBILITY_DEFAULT
#else
  #define LAME_ATTR_VISIBILITY_DEFAULT __attribute__((visibility("default")))
#endif
 ...
 * API calls.
 */
lame_global_flags LAME_ATTR_VISIBILITY_DEFAULT * CDECL lame_init(void);
...
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_in_samplerate(lame_global_flags *, int);
int CDECL lame_get_in_samplerate(const lame_global_flags *);

/* number of channels in input stream. default=2  */
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_num_channels(lame_global_flags *, int);
...
/*
  ...
  (not used by decoding routines)
*/
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_out_samplerate(lame_global_flags *, int);
...
*/
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_quality(lame_global_flags *, int);
...
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_brate(lame_global_flags *, int);
...
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_VBR(lame_global_flags *, vbr_mode);
...
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_VBR_quality(lame_global_flags *, float);
float CDECL lame_get_VBR_quality(const lame_global_flags *);

/* Ignored except for VBR=vbr_abr (ABR mode) */
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_set_VBR_mean_bitrate_kbps(lame_global_flags *, int);
 ...
 */
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_init_params(lame_global_flags *);
 ...
 *
*/
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_encode_buffer (
 ...
 */
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_encode_buffer_interleaved(
 ...
 */
int LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_encode_flush(
        lame_global_flags *  gfp,    /* global context handle                 */
        unsigned char*       mp3buf, /* pointer to encoded MP3 stream         */
...
*/
void LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_mp3_tags_fid(lame_global_flags *, FILE* fid);
#endif
 ...
 */
int  LAME_ATTR_VISIBILITY_DEFAULT CDECL lame_close (lame_global_flags *);
...
void LAME_ATTR_VISIBILITY_DEFAULT CDECL id3tag_set_title(lame_t gfp, const char* title);
void CDECL id3tag_set_artist(lame_t gfp, const char* artist);
void LAME_ATTR_VISIBILITY_DEFAULT CDECL id3tag_set_album(lame_t gfp, const char* album);
void LAME_ATTR_VISIBILITY_DEFAULT CDECL id3tag_set_comment(lame_t gfp, const char* comment);
...
int LAME_ATTR_VISIBILITY_DEFAULT CDECL id3tag_set_albumart(lame_t gfp, const char* image, size_t size);
