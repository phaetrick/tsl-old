...
class GHOST_DropTargetX11 {
 public:
   ...
   */
  void *getGhostData(Atom dropType, unsigned char *dropBuffer, int32_t dropBufferSize);
 ...
 private:
   ...
   */
  void *getURIListGhostData(unsigned char *dropBuffer, int32_t dropBufferSize);
